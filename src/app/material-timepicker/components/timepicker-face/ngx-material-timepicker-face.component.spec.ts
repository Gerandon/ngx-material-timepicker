...
describe('NgxMaterialTimepickerFaceComponent', () => {
    ...
    describe('Select time', () => {
        ...
        it.skip('should return angle from II quarter', fakeAsync(() => {
            let selectedTime: ClockFaceTime = {time: 1, angle: 5};
        ...
        it.skip('should return angle from III quarter', fakeAsync(() => {
            let selectedTime: ClockFaceTime = {time: 1, angle: 5};
        ...
        it.skip('should return angle from IV quarter', fakeAsync(() => {
            let selectedTime: ClockFaceTime = {time: 1, angle: 5};
        ...
        it.skip('should select hour from inner clock face', fakeAsync(() => {
            let selectedTime: ClockFaceTime = {time: 1, angle: 5};
        ...
        it.skip('should emit selected time once user stop interaction with clock face', waitForAsync(() => {
            const mouseCords: MouseEventInit = {clientX: 20, clientY: 20};
